# atavishaala-fleet-portal

Vite · React 18 · TanStack Query · Router 6 → Cloudflare Pages at `fleet.atavishaala.in`.

Delivery-company self-serve, mobile-first for riders. 24 screens. Consumes `/api/v1/fleet` only, through `@atavishaala/kit`.
Owner: FE-2.

Specification: `docs/AA-07_Fleet_Portal_Specification.pdf`.
