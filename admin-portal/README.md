# atavishaala-admin-portal

Vite · React 18 · TanStack Query · Router 6 → Cloudflare Pages at `admin.atavishaala.in`.

Internal staff console, including the agronomist Advisor console. 41 screens. Consumes `/api/v1/admin` only, through `@atavishaala/kit`.
Owner: FE-1.

Specification: `docs/AA-05_Admin_Portal_Specification.pdf`.
